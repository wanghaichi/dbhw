...
<div id="page-wrapper">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg-6">
                <ol class="breadcrumb">
                    <form class="form-search" action="<?php echo U('stuList');?>" method="get">
                        <select name="type">
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-hover table-striped">
                    ...
                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td><?php echo ($vo["in_age"]); ?></td>
                            <td>
                                <?php if($vo['gender'] == 1): ?>男
                                    <?php else: ?>
                                    女<?php endif; ?>
                            </td>
                            <td><?php echo ($vo["in_year"]); ?></td>
                            <td><a href="<?php echo U('stuDel', array('id' => $vo['sno']));?>"><button type="button" class="btn btn-xs btn-danger">删除</button></a>
                                </a></td>
