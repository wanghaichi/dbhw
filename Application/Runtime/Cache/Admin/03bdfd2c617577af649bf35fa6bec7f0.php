    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <form role="form" name="addCourse" action="<?php echo U('addCourse');?>" method="post" enctype="multipart/form-data">

                            <div class="form-group">
                                <label>课程编号（必填）</label>
                                <input name="id" class="form-control" placeholder="请输入10位教务系统中该课程的课程编号，如未申请，请前往教务处申请">
                            </div>
                            <div class="form-group">
                                 <label>课程名称（必填）</label>
                                 <input name="name" class="form-control" placeholder="请输入名称：如高等数学">
                            </div>
                            <div class="form-group">
                                <label>授课老师（必填）</label>
                                <input name="teacher" class="form-control" placeholder="请输入教师名称：如云日天">
                            </div>
                            <div class="form-group">
                                <label>学分（必填）</label>
