                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover table-striped">
                                ...
                                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                        ...
                                        <td><?php echo ($vo["stud_sno"]); ?></td>
                                        <td>
                                            <form name="score" method="post" action="<?php echo U('setScore', array('sid' => $vo['stud_sno'], 'cid' => $vo['classs_id']));?>">
                                                <input type="text" size="1px" name="score" value="<?php echo ($vo["score"]); ?>"/>
                                        ...
                                        <td>
                                            <a href="<?php echo U('selDel', array('sid' => $vo['stud_sno'], 'cid' => $vo['classs_id']));?>">
