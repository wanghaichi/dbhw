...
<div id="wrapper">
    ...
    <!--[if lte IE 8]><script src="/whc_dbhw/Public/assets//excanvas.min.js"></script><![endif]-->
    <script src="/whc_dbhw/Public/assets/js/plugins/flot/jquery.flot.js"></script>
    <script src="/whc_dbhw/Public/assets/js/plugins/flot/jquery.flot.tooltip.min.js"></script>
    <script src="/whc_dbhw/Public/assets/js/plugins/flot/jquery.flot.resize.js"></script>
    <script src="/whc_dbhw/Public/assets/js/plugins/flot/jquery.flot.pie.js"></script>
    <script src="/whc_dbhw/Public/assets/js/plugins/flot/flot-data.js"></script>
